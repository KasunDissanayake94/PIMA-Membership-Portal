    ...
    <?php if ($this->session->userdata('type') == 'Admin'): ?>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="<?php echo base_url();?>index.php/adminController/viewGroups">View groups</a>

                <a class="dropdown-item" href="<?php echo base_url();?>index.php/adminController/studentGroups">Create new</a>

...
<?php foreach($dropdown as $item ){?>  
    ...
    <div class="row">
        ...
        <div class="col-md-3">
        <a href="<?php echo base_url() ?>newformquestion/saveNewOptions/<?php echo $form_element_id?>/<?php echo $name;?>/<?php echo $form_id;?>" class="btn btn-success">ADD MORE </a>
        </div>
    </div>
...
<?php }else{?>
    ...
    <?php }?>
    <a href="<?php echo base_url() ?>newformquestion/select_form/<?php echo $form_id;?>" class="btn btn-primary">BACK</a>
    </div>

...
<?php echo form_open_multipart('newformquestion/saveFormName');?>

    <h1><label>MAKING A NEW Questionnaire</label> <br></h1>


        <h3><label>ENTER THE Questionnaire NAME  </label></h3>

            ...
            <div class="row">
              <div class="col-6">
                <div class="p-3 mb-2 bg-light text-dark">
                  <div class="row">
                    <div class="col-9">
                      <p class="left-align"><b>Tele Marketing Executive: <?php echo $tme_name?></b></p>
                    </div>
                    <div class="col-3">
                  ...
                  <form action="<?php echo base_url();?>adminController/changeTME?group_id=<?php echo $gid?>&group_title=<?php echo $group_title?>" method="POST">
                  <div class="row">
                  <div class="container">
                          <div class="collapse" id="collapseExample">
                            <div class="card card-body">
                                ...
                                <label class="col-sm-3 col-form-label">Select</label>
                                  <div class="col-sm-9">
                                    <select class="form-control" id="sel1" name="tme">
                                    <?php
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Change Tele Marketing Executive</h5>
              ...
              <div class="col-6">
                  <div class="p-3 mb-2 bg-light text-dark">
                    <div class="row">
                      <div class="col-4">
                      <form id="frm-example1" action="<?php echo base_url();?>adminController/removeStudentsOfMG?group_id=<?php echo $gid?>&group_title=<?php echo $group_title?>" method="POST">
                      ...
                      <div class="col-8">
                        <div class="float-right">
                          <button id="btnmove" type="button" class="btn btn-outline-warning btn-sm" data-toggle="modal" data-target="#exampleModalThree">Move to another group</button>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <div class="modal fade" id="exampleModalTwo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      <!-- Move students to another group modal -->

                    <div class="modal fade" id="exampleModalThree" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Move selected students to another group</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                              ...
                              <label class="col-sm-3 col-form-label">Select group</label>
                                  <div class="col-sm-9">
                                    <select class="form-control" id="sel1" name="newgroup_id">
                                    <?php
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <input type="submit" formaction="<?php echo base_url();?>adminController/moveStudentsMG?group_id=<?php echo $gid?>&group_title=<?php echo $group_title?>" name="submitOne" class="btn btn-info">
                          </div>
                        </div>
                      </div>
                    </div>

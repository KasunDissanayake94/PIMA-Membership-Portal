            ...
            <div class="row">
                ...
                <?php
                    ...
                    if($main_groups->num_rows() > 0)
                    {
                        ...
                        <a class=\"btn btn-outline-danger btn-sm\" href=\"deleteMainGroup?group_id=$row->id\">delete</a>
                        </div>
                        </li>
                        </ul>
                        ";
                ...
                <div class="col-3">
                 <a href="viewAllStudents"><button type="button" class="btn btn-secondary btn-block">Create new group</button></a>
                </div>
            </div>

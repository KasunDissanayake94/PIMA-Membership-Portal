    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Select The Form</li>
            </ol>
...
<h4><?php echo $this->session->flashdata('newoptionnotsaved');?></h4>
    ...
    <?php echo form_open_multipart('newform/saveFormFieldNameAndType');?>
    <h1><label>Already Existing Form</label> <br></h1>
  ...
  <h1><label>Add New Fields To The Form</label> <br></h1>
    ...
    <div class="span12">
        <div style="overflow:hidden;width:90%;">
            <div style="display:inline-block;width:100px">
				<form method="" action="<?php  echo base_url(); ?>newform/changeOptionView/<?php echo $form_id?>">

                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <form action="" method="POST" class="form-inline my-2 my-lg-0">
                            ...
                            <input class="form-control mr-sm-2" type="text" name="search_designation" id="search_designation" placeholder="Search by Designation" aria-label="Search">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="customRadio1">All Users&nbsp&nbsp</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio2" name="customRadio" value="2" class="custom-control-input">
                                        <label class="custom-control-label" for="customRadio2">Registered Users&nbsp&nbsp</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio3" name="customRadio" value="3" class="custom-control-input">
                                        <label class="custom-control-label" for="customRadio3">Pending Users&nbsp</label>
                                    </div>
                                    <div class="custom-control custom-radio">
                                        <input type="radio" id="customRadio4" name="customRadio" value="4" class="custom-control-input" >
                                        <label class="custom-control-label" for="customRadio4">Deleted Users&nbsp&nbsp</label>
                                    </div>
    ...
    $(document).ready(function(){
        ...
        function load_data()
        {
            $.ajax({
                ...
                method:"POST",
                data:{data1:search_name,data2:search_designation,data3:search_option},

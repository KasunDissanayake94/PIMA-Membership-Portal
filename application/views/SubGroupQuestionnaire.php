    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Sub group questionnaire - <?php echo $group_title?></li>
            </ol>

            <div class="container">
            <div class="row"><p class="left-align"><b>Course Counselor: <?php echo $tme_name?></b></p></div>
            </div>
            
            <div class="row">
                <div class="col-6">
                <form method="POST" action="<?php echo base_url()?>adminController/removeSGQuestionnaire?group_id=<?php echo $gid?>&group_title=<?php echo $group_title?>&$tme_name=<?php echo $tme_name?>">
                <?php
                ...
                <button name="submitOne" type="submit" class="btn btn-outline-danger btn-block">Remove questionnaire</button>
                  ...
                  <div class="row">
                  <hr>
                  <form method="POST" action="<?php echo base_url()?>adminController/addSGQuestionnaire?group_id=<?php echo $gid?>&group_title=<?php echo $group_title?>&$tme_name=<?php echo $tme_name?>">
                  </div>
